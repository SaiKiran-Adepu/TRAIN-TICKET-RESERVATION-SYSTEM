...
out.println("</tr>");
       ...
       out.println("</tr>");
        ...
        out.println("<td><b>Class Charges:&nbsp</b>"+rs2.getInt(16)+"</td>");
         out.println("<td><b>Quota Charges:&nbsp</b>"+rs2.getInt(17)+"</td>");
          out.println("<td><b>Total RS:&nbsp</b>"+rs2.getInt(18)+"&nbsp&nbsp&nbsp <b>Payment Mode:</b>"+rs2.getString(28)+"</td>");
  ...
  out.println("<h2>INSTRUCTIONS</h2>");
          out.println("<p><font color=blue>* Observations CNF-> Confirmed CAN-> Cancelled</font></p>");
