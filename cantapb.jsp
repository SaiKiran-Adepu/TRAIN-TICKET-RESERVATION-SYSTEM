...
out.println("</tr>");
    ...
    out.println("</tr>");
        ...
        while (rs3.next()) 
      {
        ...
        out.println("<td>&nbsp&nbsp"+rs2.getString(25)+"&nbsp<font color=red>(Cancelled)</font> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp CNF/"+ rs2.getString(12) +"/"+rs3.getInt(5)+"/"+rs3.getString(6)+ "</td>");
        out.println("</tr>");
