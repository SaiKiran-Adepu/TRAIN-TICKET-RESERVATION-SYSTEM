...
<html>
<head>
<title>DOWNLOAD TRAIN CANCELLED TICKET DETAILS</title>
</head>
    ...
    public void jspInit()
    {
        ...
        { 
            ...
            ps2 = con.prepareStatement("select * from train_reservation where Booked_by=? AND PNR=? ORDER BY PNR");
             ps3 = con.prepareStatement("select * from train_sitting where tusr=? and pnr=? ORDER BY tbd DESC");
             String query = "SELECT CONCAT( TIME_FORMAT(STR_TO_DATE(Booked_On, '%H:%i:%s %Y-%m-%d'), '%h:%i:%s %p'), ' ', DATE_FORMAT(STR_TO_DATE(Booked_On, '%H:%i:%s %Y-%m-%d'), '%d-%b-%Y') ) AS Book, DATE_FORMAT(STR_TO_DATE(Booked_For, '%Y-%m-%d'), '%d-%b-%Y') AS journey FROM train_reservation WHERE booked_by = ? and pnr=?";
...
<% 
       ...
       int pnr=Integer.parseInt(request.getParameter("pnr"));
        ...
        out.println("<center><h3><font color=red>CANCELLATION DETAILS</font></h3></center>");
        ...
        out.println("<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<h3><font color=Blue>&nbsp&nbsp Electric Cancellation Slip(ECS) E-TICKET</font></h3>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>");
        //out.println("<td><img src=images/train11.jpg margin-right:5px;></td>");
        out.println("<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<img src=images/qr.jpg width=220 height=180 style=float: right; margin-right:5px;></td>");
                out.println("</tr>");
...
while (rs4.next()) {
    ...
    out.println("<td>KM:&nbsp" + rs2.getInt(19)+"&nbsp&nbsp BOOKING DATE: " +Book+ "</td>");
...
out.println("</tr>");
    ...
    out.println("</tr>");
        ...
        while (rs3.next()) 
      {
        ...
        out.println("<td>&nbsp&nbsp&nbsp&nbsp"+rs2.getString(25)+"&nbsp<font color=red>(CANCELLED)</font> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp CNF/"+ rs2.getString(12) +"/"+rs3.getInt(5)+"/"+rs3.getString(6)+ "</td>");
        out.println("</tr>");
    ...
    out.println("</tr>");
       ...
       out.println("</tr>");
        ...
        out.println("<td><b>Class Charges:&nbsp</b>"+rs2.getInt(16)+"</td>");
         out.println("<td><b>Quota Charges:&nbsp</b>"+rs2.getInt(17)+"&nbsp&nbsp&nbsp<b>Total RS:&nbsp</b>"+rs2.getInt(18)+"</td>");
          out.println("<td><b>Payment Mode:&nbsp</b>"+rs2.getString(28)+"</td>");
          
          //out.println("&nbsp&nbsp&nbsp&nbspTicket Booked by Admin:&nbsp&nbsp"+rs2.getString(23)+"</td>");
          out.println("</tr>");
          out.println("<tr>");
          int rs=rs2.getInt(18);
          int cfe = (int)((double)rs * 0.40);
          int refam=rs-cfe;

          out.println("<td><b>Cancellation Charges:&nbsp</b>"+cfe);
          out.println("<td><b>Total Refund Amount RS:&nbsp</b>"+refam);
          out.println("<td><b>Amount Credited to User Bank:&nbsp YES</b>");
          //out.println("&nbsp&nbsp&nbsp&nbspTicket Booked by Admin:&nbsp&nbsp"+rs2.getString(23)+"</td>");
          out.println("</tr>");
