...
<html lang="en">
    ...
    <body>
	<center>
        <form method = "post" onSubmit="return login(this)" action = "cantapb.jsp">
		...
		<h3><font color="blue">THE ADMIN CAN DOWNLOAD/PRINT THE RESERVATION CANCELLED TICKET.</font></h3>
        <br>
