...
out.println("</tr>");
  ...
  out.println("<tr>");
    ...
    out.println("</tr>");
     ...
     out.println("<tr>");
        out.println("<center><td><font color=blue>&nbsp PAYMENT DETAILS<font></td></center>");/////
        out.println("</tr>");
        out.println("<tr>");
       ...
       out.println("</tr>");
        ...
        out.println("<td>Class Charges:&nbsp&nbsp"+rs2.getInt(16)+"</td>");
         out.println("<td>Quota Charges:&nbsp"+rs2.getInt(17)+"&nbsp&nbsp Payment Mode:&nbsp"+rs2.getString(28)+"</td>");
