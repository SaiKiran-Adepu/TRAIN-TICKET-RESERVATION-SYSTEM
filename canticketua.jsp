...
<%!
	...
	public void jspInit()
    {
      ...
      ps1 = con.prepareStatement("select fare from train_reservation where pnr=? and booked_for=? and status='CNF' ");
...
<html lang="en">
		...
		function clearFunc()
	{
		...
		document.getElementById("pwd1").value="";
            ...
            <script>
        setTimeout(function() {
            location.reload(); // Reload the page after a specified time interval
        }, 20000); // Refresh every 5 seconds (specified in milliseconds)
    </script>
    ...
    <body>
      	...
      	<center>
        <form method = "post" onSubmit="return login(this)" action = "canticketub.jsp">
...
%>
  ...
  <%
         out.println("<p><font color=blue>SKA Railwyas Recovers Only 61% of Cost of Travel on an average Ticket & Reservation Tickets</font></p>");
           out.println("<p><font color=blue>Please Done Trasaction in 20 Seconds...</font></p>");
