         ...
         Map<String, String> passengerData = new HashMap<>();
          passengerData.put("Name", pname2);
            ...
            passengerList.add(passengerData);
                ...
                out.println("<td><textarea rows1 cols=15 name=pname2[] readonly>"+pname2+"</textarea></td>");
                out.println("<td><textarea rows1 cols=15 name=page2[] readonly>"+page2+"</textarea></td>");
                 out.println("<td><textarea rows1 cols=15 name=pgen2[] readonly>"+pgen2+"</textarea></td>");
                  out.println("<td><textarea rows1 cols=15 name=pbth2[] readonly>"+pbth2+"</textarea></td>");
    }
